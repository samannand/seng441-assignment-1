...
/*package*/ class Trigger_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Trigger_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.target$C_cY;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.target$C_cY);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_j8pslm_b0");
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.signal$C_c0;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
