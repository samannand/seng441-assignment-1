...
/*package*/ class App_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new sensorsListHandler_g38wqt_b3a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
  ...
  private static class sensorsListHandler_g38wqt_b3a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public sensorsListHandler_g38wqt_b3a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(sensorsListHandler_g38wqt_b3a.this.getNode(), LINKS.sensors$OW5N));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_2() {
      ...
      editorCell.setCellId("Constant_g38wqt_a1d0");
      editorCell.setDefaultText("");
      return editorCell;
    }
  }
  ...
  private static class statesListHandler_g38wqt_b4a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(statesListHandler_g38wqt_b4a.this.getNode(), LINKS.states$X78Y));
      try {
        EditorCell emptyCell = null;
