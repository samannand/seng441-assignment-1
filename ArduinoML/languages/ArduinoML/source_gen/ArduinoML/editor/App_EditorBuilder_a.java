...
/*package*/ class App_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "appliction");
  ...
  private static class actuatorsListHandler_g38wqt_b2a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.actuators$X79W;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Actuator$oh;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(actuatorsListHandler_g38wqt_b2a.this.getNode(), LINKS.actuators$X79W));
      try {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new sevsegSingleRoleHandler_g38wqt_b3a(myNode, LINKS.sevseg$SczX, getEditorContext());
    return provider.createCell();
  }
  private static class sevsegSingleRoleHandler_g38wqt_b3a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public sevsegSingleRoleHandler_g38wqt_b3a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.sevseg$SczX, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.sevseg$SczX, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.sevseg$SczX);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.sevseg$SczX));
      try {
        EditorCell editorCell = super.createEmptyCell();
        editorCell.setCellId("empty_sevseg");
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new sensorsListHandler_g38wqt_b4a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
  ...
  private static class sensorsListHandler_g38wqt_b4a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public sensorsListHandler_g38wqt_b4a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.sensors$OW5N;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Sensor$Zb;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(sensorsListHandler_g38wqt_b4a.this.getNode(), LINKS.sensors$OW5N));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_2() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "no sensors defined");
  ...
  private EditorCell createCollection_5() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_g38wqt_f0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNodeList_2() {
    AbstractCellListHandler handler = new statesListHandler_g38wqt_b5a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
  ...
  private static class statesListHandler_g38wqt_b5a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.states$X78Y;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.State$7N;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(statesListHandler_g38wqt_b5a.this.getNode(), LINKS.states$X78Y));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_3() {
      ...
      editorCell.setCellId("Constant_g38wqt_a1f0");
      editorCell.setDefaultText("");
      return editorCell;
    }
  }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Sensor$Zb = MetaAdapterFactory.getConcept(0xfdef8274844e4810L, 0xbe06dd00182a0144L, 0x23d3a26334f46719L, "ArduinoML.structure.Sensor");
