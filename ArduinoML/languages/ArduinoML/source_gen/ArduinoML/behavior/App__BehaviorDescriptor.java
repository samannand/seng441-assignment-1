...
public final class App__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xfdef8274844e4810L, 0xbe06dd00182a0144L, 0x1eff328ee4ca89f8L, "ArduinoML.structure.App");
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), CONCEPTS.State$7N)) {

      return SimpleRoleScope.forNamedElements(__thisNode__, LINKS.states$X78Y);
    }
    if (SConceptOperations.isSuperConceptOf(SNodeOperations.asSConcept(kind), CONCEPTS.Actuator$oh)) {
      return SimpleRoleScope.forNamedElements(__thisNode__, LINKS.actuators$X79W);
